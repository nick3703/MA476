...
Now.  None of this has anything to do with probability or statistics.  Set theory is a tool, like Caculus is a tool, that can potentially help us.  But let's go back to probability theory.  We are going to define a \textbf{Probability Space} which consists of three things.  A sample space, a list of events we are potentially interested in, and probabilities of those events occurring.  We will start with \textbf{Discrete } outcomes.
...
Now, we have our discrete sample space, a way to come up with events of interest (any set  $A$ consisting in events from $S$), and a way to assign probabilities to $A$.
